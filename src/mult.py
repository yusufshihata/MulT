...
class CrossModalTransformerLayer(nn.Module):
    def init(self, dims: int, num_heads: int, primary_feature_dim: int, secondary_feature_dim: int, dropout: float = 0.1):
...
class CrossModalTransformer(nn.Module):
    def init(self, primary_feature_dim: int, secondary_feature_dim: int, dims: int, num_heads: int, num_layers: int = 4, dropout: float = 0.1):
